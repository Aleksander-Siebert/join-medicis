...
function ResourceCard({
  ...
  return (
    <Link
      ...
      className="group flex flex-col bg-cream-100 border border-ink-100 p-6 rounded-[25px] hover:border-forest-600 hover:shadow-[0_2px_24px_-12px_rgba(26,51,40,0.4)] transition-all duration-200"
    >
      {/* Logo + meta */}
